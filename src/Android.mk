...
LOCAL_CFLAGS := -DBACKEND_TYPE=cpu -DCONF_NO_CUDA -DCONF_NO_OPENCL -DCONF_NO_HWLOC -DCONF_NO_TLS -DCONF_NO_HTTPD -DUSE_C_PTHREAD -Os
LOCAL_CPPFLAGS := -DBACKEND_TYPE=cpu -DCONF_NO_CUDA -DCONF_NO_OPENCL -DCONF_NO_HWLOC -DCONF_NO_TLS -DCONF_NO_HTTPD -DUSE_C_PTHREAD -Os -std=c++11
